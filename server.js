...
io.on('connection', function(socket) {
  ...
  if (Object.keys(io.sockets.connected).length > 1) {
    zombieManager = false;
  } else if (Object.keys(io.sockets.connected).length = 1) {
    zombieManager = true;
  } else {
      zombieManager = false;
  }
//   console.log('zombieManager', zombieManager)
//   console.log('Sockets=', Object.keys(io.sockets.connected)[0]);
  ID = Object.keys(io.sockets.connected)[0]
  gameZombies = [];
  ...
  socket.on('dead-player', function(state) {
      console.log('deadness', state)
...
function ServerGameLoop() {
    ...
    // }
    // console.log('IDDDD', Object.keys(io.sockets.connected))
